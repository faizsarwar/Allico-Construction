  ...
  <div class="home pt-4 pb-5">
        ...
        <div class="row p-5">
            <div class="col-8 text-left">
                ...
                <div class="pt-5 pb-5">
                    ...
                    <p>If you encounter any trouble during the tax exempt filing process, feel free to give us a call at (877) 746-6544 and one of our greenhouse experts can guide you through the process. Happy growing!</p>
                    <!-- <a href="" class="btn btn p-2 pl-3 pr-3" style="background-color:red; color: white"> Submit Docs</a> -->
                </div>
            </div>
            <div class="col-4">
    ...
    <section>
        ...
        <div class="row mt-4 mb-4 ml-2 mr-2">
            ...
            <div class="col no-overflow" >
            <div class="card cards collections"  :style="{ backgroundImage: 'url(' + require('@/assets/img/7.jpg') + ')' }">
                <div class="card-body no-overflow p-4 pt-5" >
