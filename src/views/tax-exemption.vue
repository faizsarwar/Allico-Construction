<template>
  <div class="home pt-4 pb-5">
    ...
    <h1 style="color:#2490d1; text-align: center;" class="p-4"><b> TAX EXEMPTION </b></h1>
    ...
    <sectdion>
        <div class="row p-5">
            <div class="p-5 text-left">
                ...
                <hr>
                <div class="p-3 card">
                    <h2 style="color:#2490d1; " ><b> Step 1 </b></h2>
                    <p>Create an account on the ALLICO store:</p>
                    <a href="" class="btn btn p-2 pl-3 pr-3" style="background-color:red; color: white"> Create Account</a>
                </div>
                <hr>
                <div class="p-3 card">
                    <h2 style="color:#2490d1; " ><b> Step 2 </b></h2>
                    <p>Download the necessary tax exemption documents for your state and fill in your information</p>
                    <!-- <a href="" class="btn btn p-2 pl-3 pr-3" style="background-color:red; color: white"> Create Account</a> -->
                </div>
                <hr>
                <div class="p-3 card">
                    <h2 style="color:#2490d1; " ><b> Step 3 </b></h2>
                    <p>Send your tax exemption documents to our Customer Service Department at AnassBoukili@gmail.com</p>
                    <a href="" class="btn btn p-2 pl-3 pr-3" style="background-color:red; color: white"> Submit Docs</a>
                </div>
                <hr>
                <div class="p-3 card">
                    <h2 style="color:#2490d1; " ><b> Step 4 </b></h2>
                    <p>Check for an email notification saying that one of our administrators has adjusted your account.</p>
                    <!-- <a href="" class="btn btn p-2 pl-3 pr-3" style="background-color:red; color: white"> Submit Docs</a> -->
                </div>
                <hr>
                <div class="p-3 card">
                    <h2 style="color:#2490d1; " ><b> Step 5 </b></h2>
                    <b>Place your order!</b>
                    <p>If you encounter any trouble during the tax exempt filing process, feel free to give us a call at +1 (609) 375-0046 and one of our greenhouse experts can guide you through the process. Happy growing!</p>
                    <!-- <a href="" class="btn btn p-2 pl-3 pr-3" style="background-color:red; color: white"> Submit Docs</a> -->
                </div>
            </div>
            <div class="col-12 ">
