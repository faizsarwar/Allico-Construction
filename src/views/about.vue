    ...
    <section class="p-5">
        ...
        <div class="row pl-4 pr-4">
            <div class="col-8 text-left">
                ...
                <br>
                <p class=" ">
                    Our mission is to offer growers and investors innovative horticultural greenhouses that meet the highest quality standards, which helps you reaching the highest yield from your crop. We respect sustainability and work conditions according the principles outlined in the Sustainable Development Goals of the United Nations.
                </p>
        ...
        <div class="row pl-4 pr-4">
            <div class="col-6 text-left">
                ...
                <ul>
                    ...
                    <li class="m-0 p-0">Flowers</li>
                    <li class="m-0 p-0">Herbs</li>
                    <li class="m-0 p-0">Breeding</li>
                    <li class="m-0 p-0">Propagating young plants</li>
                    <li class="m-0 p-0">Nursery Stock</li>
                    <li class="m-0 p-0">Projects for universities and horticultural colleges</li>
    ...
    <section >
        ...
        <div class="row" >
          <div class="col-lg text-left pl-5 pt-2 " >
              <div class=" mr-5 pt-3 pr-5 pl-5 pb-4 ">
