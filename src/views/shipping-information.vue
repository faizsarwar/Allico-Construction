<template>
  <div class="home pt-4 pb-5">
    ...
    <h1 style="color:#2490d1; text-align: center;" class="p-4"><b> SHIPPING INFORMATION </b></h1>
...
options.</p>
                ...
                <hr>
                <div class="p-4 card">
                    <h2 style="color:#2490d1; " ><b> Offerings </b></h2>
                    <!-- <b>Place your order!</b> -->
                    <p>Offerings listed are made subject to being available. We will not be held responsible for delays in shipment caused by conditions beyond our control. Applicable substitutes will be made when necessary.</p>
                    <!-- <a href="" class="btn btn p-2 pl-3 pr-3" style="background-color:red; color: white"> Submit Docs</a> -->
                </div>
                <hr>
                <div class="p-4 card">
...
and manufacturer’s rights to change this contract are limited.</p>
    ...
    <section >
        ...
        <div class="row" >
          <div class="col-lg text-left pl-5 pt-4 " >
